...
export class FormControlValidationMessageComponent implements OnChanges, DoCheck {
  ...
  */
   ...
   * Form control.
   */
  public formControl$ = new BehaviorSubject<AbstractControl | null>(null);
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    ...
    let formControl: AbstractControl | null = this.control || null;
    if ('controlName' in changes && this.controlName != null) {
      formControl = this.parent.control && this.parent.control.get(this.controlName.toString());
    }
  ...
  public ngDoCheck(): void {
    ...
    let formControl = this.control || null;
